...
// #1 TODO: Declare fastify object from fastify, and 
...
fastify.get("/photos", (request, reply) => {
    ...
    fetch('https://jsonplaceholder.typicode.com/photos')   
        .then(response => response.json()) //transforms data
        .then((photos) => { //handling transformed data
            reply  
            .code(200)
        ...
        .catch((err) => {
            ...
            .send({error: "Something went wrong!", statusCode: 404, photos: []})
        })
  ...
  fastify.get("/photos/:id", (request, reply) => {
    ...
    .catch((err) => {
        ...
        .code(404)
        .header("Content-Type", "text/json; charset=utf-8")
        .send({error: "Invalid photo id", statusCode: 404, photos: []})
    })
